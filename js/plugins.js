...
{"name":"SyncVariable","status":true,"description":"ユーザ間の変数同期プラグイン","parameters":{"ユーザID":"susumago0077","同期開始変数番号":"81","同期終了変数番号":"100","同期開始スイッチ番号":"41","同期終了スイッチ番号":"60","認証ファイル形式":"OFF"}},
